...
function createMain() {
  ...
  modalDescription.textContent = 'Данный интернет-магазин не является коммерческим проектом, а является результатом самостоятельной учебной работы при изучении курса вебразработки. Марка «Bait Store», контактные данные и реквизиты интернет-магазина, условия работы с интернет-магазином, а также все товары и материалы, представленные в интернет-магазине, носят исключительно вымышленный характер и являются частью общего выдуманного контента (любые совпадения с реальными лицами, проектами и с прочими обстоятельствами случайны).';
